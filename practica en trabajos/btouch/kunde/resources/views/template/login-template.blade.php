...
<div class="lockscreen-wrapper supreme-container">
    <div class="lockscreen-logo container-fluid">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding_none login_template_title" >@lang("titles.title-template-login")</div>
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 padding_none" style="margin-left: 85%;margin-top: 10px"><img src="/img/kundelogo.png" ></div>
        {{--<a href="#"><b>Social</b>Kunde</a>--}}
    </div>
    @yield("content")
</div><!-- /.register-box -->


@include('/template/terminos')

@include('/template/leyes')
...
<div class="lockscreen-footer text-center" style="
      margin-top: 40px;
      ">
    <!--<img src="{{asset('/img/whitelogo.png')}}" alt="User Image">2016 Powered by BTouch Inc. &copy;<b><a href="http://www.placeyourfinger.com.mx" class="text-black"></a></b><br>-->
</div>
</body>
</html>
<!-- jQuery 2.1.4 -->
