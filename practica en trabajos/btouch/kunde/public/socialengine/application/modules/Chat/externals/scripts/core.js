...
// // preload chat sound
soundManager.setup({url: en4.core.staticBaseUrl + 'externals/soundmanager/swf/'});
  ...
  render : function() {
    ...
    if( this.options.showHide ) {
      ...
      this.elements.menuHideLink = new Element('a', {
        ...
        'html' : '<img src="' + en4.core.staticBaseUrl + 'application/modules/Chat/externals/images/window_hide.png" />',
        'events' : {
    ...
    if( this.options.showClose ) {
      ...
      this.elements.itemCloseLink = new Element('a', {
        ...
        /* @todo change to bgimage */
        'html' : '<img src="' + en4.core.staticBaseUrl +  'application/modules/Chat/externals/images/window_close.png" />',
        'events' : {
...
ChatHandler_Whispers_UI_Settings = new Class({
  ...
  toggleOnline : function(state) {
    ...
    if( state == 0 ) {
      ...
      this.elements.tooltip.set('text', en4.core.language.translate('Go Offline'));
