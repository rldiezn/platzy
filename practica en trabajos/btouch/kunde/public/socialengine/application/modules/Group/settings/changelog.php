...
return array(
  ...
  '4.7.0' => array(
    ...
    'settings/changelog.php' => 'Incremented version',
    'settings/manifest.php' => 'Incremented version',
    'settings/my-upgrade-4.6.0-4.7.0.sql' => 'Added',
    'settings/my.sql' => 'Incremented version',
    'views/scripts/photo/view.tpl' => 'Minimized TinyMCE',
    'views/scripts/topic/view.tpl' => 'Upgraded TinyMCE',
  ),
  '4.6.0' => array(
    'Model/DbTable/Groups.php' => 'Fixed incorrect query when searching',
    'settings/changelog.php' => 'Incremented version',
    'settings/manifest.php' => 'Incremented version',
    'settings/my.sql' => 'Incremented version',
  ),
  '4.5.0' => array(
    'controllers/PostController.php' => 'Fixed escaping issue',
    'settings/changelog.php' => 'Incremented version',
    'settings/manifest.php' => 'Incremented version',
    'settings/my.sql' => 'Incremented version',
    'views/scripts/group/edit.tpl' => 'Setting active class on main menu',
    ...
    'views/scripts/photo/list.tpl' => 'Setting active class on main menu',
  ...
  '4.3.0' => array(
    ...
    'controllers/PhotoController.php' => 'Fixed issue where photos would get uploaded even if cancelled',
    'controllers/TopicController.php' => 'Group discussions now show up in group activity feed',
    'Model/Topic.php' => 'Group discussions now show up in group activity feed',
    'settings/changelog.php' => 'Incremented version',
  ...
  '4.2.9' => array(
    'Form/Filter/Browse.php' => 'Allow text search on browse-group widget',
    'Model/DbTable/Groups.php' => 'Allow text search on browse-group widget',
    'settings/changelog.php' => 'Incremented version',
    'settings/manifest.php' => 'Incremented version',
  ),
  '4.2.8' => array(
    '/application/languages/en/group.csv' => 'Added TINYMCE Editor',
    'controllers/AdminSettingsController.php' => 'Added TINYMCE Editor',
    'Form/Admin/Global.php' => 'Added TINYMCE Editor',
    'Form/Admin/Settings/Level.php' => 'Added TINYMCE Editor',
    'Form/Post/Create.php' => 'Added TINYMCE Editor',
    'Form/Post/Edit.php' => 'Added TINYMCE Editor',
    'Form/Topic/Create.php' => 'Added TINYMCE Editor',
    'settings/changelog.php' => 'Incremented version',
    'settings/manifest.php' => 'Incremented version',
    'settings/my-upgrade-4.2.7-4.2.8.sql' => 'Added',
    'settings/my.sql' => 'Incremented version',
    'views/scripts/index/browse.tpl' => 'Added TINYMCE Editor',
  ),
  '4.2.7' => array(
    'settings/manifest.php' => 'Incremented version',
    'settings/my.sql' => 'Incremented version',
