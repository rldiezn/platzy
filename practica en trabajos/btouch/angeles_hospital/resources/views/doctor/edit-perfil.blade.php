...
@section('content')
    <main>
        <section class="filtros_medicos" style="z-index: 0">

            <div id="a" class="background-img-profile hide  " >
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top: -7%"  style="z-index: 1">
            ...
            <div class="col-lg-9 col-md-9 col-sm-9 row col-centered"  style="z-index: 1">
                ...
                <div id="sectionGeneral" class="col-lg-12 col-md-11 col-sm-11 sectionPerfilClass container">
                    ...
                    <div  id="section_linkedin_show" class="" >
                        ...
                        <div id="container_info_profile" class="col-lg-8 col-md-12 col-sm-12 col-xs-12 box z-index-1">
                            ...
                            <div class="form-group col-lg-9 col-md-12 col-sm-12 col-xs-12">
                                <div class="col-lg-9  col-md-12 col-sm-9 col-xs-9">
                                    ...
                                    <div id="doctor_adress_edit" class="hide">
                                        ...
                                        <input type="text" name="tblLinkedInDrProfHead" placeholder="Especialidad" data-rule-required="true" data-rule-noSpecialChartsName="true" value="<?php echo(isset($doctor['infoLinkedin']->tblLinkedInDrProfHead))?$doctor['infoLinkedin']->tblLinkedInDrProfHead:"" ?>">
                                        <input type="text" name="tblLinkedInDrAddress" placeholder="Dirección" data-rule-required="true" data-rule-noSpecialChartsName="true" value="<?php echo(isset($doctor['infoLinkedin']->tblLinkedInDrAddress))?$doctor['infoLinkedin']->tblLinkedInDrAddress:"" ?>">
                                        <input type="text" name="tblLinkedInDrCountry" placeholder="Pais" data-rule-required="true" data-rule-noSpecialChartsName="true" value="<?php echo(isset($doctor['infoLinkedin']->tblLinkedInDrCountry))?$doctor['infoLinkedin']->tblLinkedInDrCountry:"" ?>">
                                        <input type="hidden" name="idtblDr" value="<?php echo $doctor['infoGeneral']->idtblDr; ?>">
                                        <input type="hidden" name="idtblLinkedInDr" value="<?php echo $doctor['infoLinkedin']->idtblLinkedInDr; ?>">
                                        <div class="form-group">
                                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2" >
                            ...
                            <br>
                            <br>
                            <div class="form-group col-lg-9 col-md-12 col-sm-12 col-xs-12 hide">
                ...
                <div id="sectionCV" class="col-lg-12 col-md-12 col-sm-12 col-xs-12  sectionPerfilClass sectionPerfilClassMarginTop container" style="width: 100%">
