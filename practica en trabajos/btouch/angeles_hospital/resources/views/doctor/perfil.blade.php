...
@section('content')
    ...
    {!! Form::open(['route'=>'doctor.store','method'=>'POST','id'=>'form_perfil_doctor','class'=>'form-horizontal','enctype'=>'multipart/form-data']) !!}
    {{--<form class="form-horizontal" id="form_perfil_doctor" method="POST" action="/doctor.store" enctype="multipart/form-data">--}}
            ...
            <div id="container_info_profile" class="col-lg-8 col-md-7 z-index-1">
                <div class="form-group">
                    ...
                    <div class="col-lg-9 col-md-12">
                        <input type="name" name="inputName" id="inputName" class="form-control" placeholder="Nombre">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-9  col-md-12">
                        <input type="text" id="inputEspecalizacion"  name="inputEspecalizacion" class="form-control" placeholder="Especalización">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-9  col-md-12">
                        <textarea rows="3" id="inputDireccion" class="form-control limitChar" placeholder="Dirección"></textarea>
        ...
        <div id="sectionExtracto" class="col-lg-12 col-md-11 col-sm-11  sectionPerfilClass">
            ...
            <div class="col-lg-8">
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <textarea rows="3" id="inputExtracto"  name="inputExtracto" class="form-control limitChar" placeholder="Dirección"></textarea>
                        <span class="help-block"></span>
                    </div>
                </div>
            </div>
