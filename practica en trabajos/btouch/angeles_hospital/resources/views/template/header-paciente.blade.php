    ...
    <div class="row">
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                ...
                <li><a href="/paciente/verPerfil/<?php echo $isDoctor['usuario']['id_usuario'] ?>"><i class="icon-angeles-perfil blue"></i>Mi Perfil</a></li>
                ...
                <li><a href="/citas/misCitas/<?php echo $isDoctor['usuario']['id_usuario'] ?>"><i class="icon-angeles-citas red"></i>Mis Citas</a></li>
                <li><a href="/citas/historialCitas/<?php echo $isDoctor['usuario']['id_usuario'] ?>"><i class="icon-angeles-historial orange"></i>Historial Médico</a></li>
