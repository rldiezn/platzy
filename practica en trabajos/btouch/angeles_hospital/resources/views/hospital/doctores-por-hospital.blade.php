...
@section('content')
    ...
    <main>
        ...
        <a href="/hospital/verHospital/<?php echo $hospital->idcatHospital ?>"><h1 class="title_section	 cyan">Directorio Médico - <?php echo $hospital->catHospitalName ?></h1></a>
        ...
        <section class="padding">
            ...
            <button type="button"
                    ...
                    data-hospital="<?php echo $hospital->catSiglas ?>"
                    data-especialidad=""
                    data-limit="50"
                    data-rows="50"
