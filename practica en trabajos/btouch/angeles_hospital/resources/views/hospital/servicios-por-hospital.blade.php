...
@section('content')
    ...
    <main>
        ...
        <a href="/hospital/verHospital/<?php echo $hospital->idcatHospital ?>"><h1 class="title_section	 cyan">Directorio deServicos - <?php echo $hospital->catHospitalName ?></h1></a>

        <section class="padding">

            <div class="list-group list_ang" id="servicio_list">

                <?php
                if(count($hospital->servicios)>0 && $hospital->servicios['rows']!=""){
                    echo $hospital->servicios['rows'];
                ?>

                <?php
                }else{
                ?>
                    <h4 class="text-center">No hay servicios asociados</h4>
                <?php
                }
                ?>
            ...
            <button type="button"
                    ...
                    data-hospital="<?php echo $hospital->idcatHospital ?>"
                    data-especialidad=""
                    data-limit="50"
                    data-rows="50"
                    data-id-table="#servicio_list"
                    data-disabled="<?php echo $hospital->servicios['disabled'] ?>"
                    class="btn btn-default btn-sm col-lg-12 col-md-12 col-sm-12 col-xs-12 boton_anadir <?php echo ($hospital->servicios['disabled']==1)? 'hide':'' ?>"
