<div id="createEventModal_<?php echo $servicio['idcatservicio'] ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></button>
                <h3 id="myModalLabel1">Reserva de cita, para el servicio <?php echo $servicio['catservicioname'] ?> </h3>
            </div>
            <div class="modal-body">
                <div class="body_form_appointment">
                    <form id="createAppointmentForm_<?php echo $servicio['idcatservicio'] ?>" class="form-horizontal">

                        <table  class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                            <tbody>
                                <tr>
                                    <td colspan="2">
                                        <label class="checkbox-inline">&nbsp;<input type="checkbox" name="solicitante_es_paciente" id="solicitante_es_paciente_<?php echo $servicio['idcatservicio'] ?>"  class="check_desblock" data-paciente="#nombre_paciente_<?php echo $servicio['idcatservicio'] ?>" data-parentesco="#parentesco_<?php echo $servicio['idcatservicio'] ?>" value="1" checked>Soy el paciente</label>
                                    </td>
                                </tr>
                                <tr class="controls">
                                    ...
                                    <td>
                                        <input readonly type="text" name="nombre_paciente" id="nombre_paciente_<?php echo $servicio['idcatservicio'] ?>" class="form-control border-radio-none border-radio-none" data-provide="typeahead" data-items="4" data-source="[&quot;Value 1&quot;,&quot;Value 2&quot;,&quot;Value 3&quot;]" value="" placeholder="" aria-describedby="basic-addon1">
                                        <input type="hidden" name="idtblDr" id="idtblDr" class="form-control border-radio-none border-radio-none" data-provide="typeahead" data-items="4" placeholder="" aria-describedby="basic-addon1" value="">
                                        ...
                                        <input type="hidden" name="idcatHospital" id="idcatHospital" class="form-control border-radio-none border-radio-none" data-provide="typeahead" data-items="4" placeholder="" aria-describedby="basic-addon1" value="<?php echo $servicio['idcatHospital']?>">
                                        <input type="hidden" name="idcatservicio" id="idcatservicio" class="form-control border-radio-none border-radio-none" data-provide="typeahead" data-items="4" placeholder="" aria-describedby="basic-addon1" value="<?php echo $servicio['idcatservicio'] ?>">
                                    </td>
                                </tr>
                                <tr class="controls">
                                    ...
                                    <td><input readonly type="text" name="parentesco" id="parentesco_<?php echo $servicio['idcatservicio']?>" class="form-control border-radio-none border-radio-none" data-provide="typeahead" data-items="4" data-source="[&quot;Value 1&quot;,&quot;Value 2&quot;,&quot;Value 3&quot;]" value="" placeholder="" aria-describedby="basic-addon1"></td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input readonly type="text" name="doctor" id="doctor" class="form-control border-radio-none border-radio-none" data-provide="typeahead" data-items="4" data-source="[&quot;Value 1&quot;,&quot;Value 2&quot;,&quot;Value 3&quot;]" value="" placeholder="" aria-describedby="basic-addon1">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input readonly type="text" name="servicio" id="servicio" class="form-control border-radio-none border-radio-none" data-provide="typeahead" data-items="4" data-source="[&quot;Value 1&quot;,&quot;Value 2&quot;,&quot;Value 3&quot;]" value="<?php echo $servicio['catservicioname'] ?>" placeholder="" aria-describedby="basic-addon1">
                                ...
                                <tr>
                                    ...
                                    <td><input readonly type="text" name="I_ESPECIALIDAD" id="I_ESPECIALIDAD" class="form-control border-radio-none border-radio-none" data-provide="typeahead" data-items="4" data-source="[&quot;Value 1&quot;,&quot;Value 2&quot;,&quot;Value 3&quot;]" value="" placeholder="" aria-describedby="basic-addon1"></td>
                                </tr>
                                <tr>
                                    ...
                                    <td><input readonly type="text" name="nombre_hospital" id="nombre_hospital" class="form-control border-radio-none border-radio-none" data-provide="typeahead" data-items="4" data-source="[&quot;Value 1&quot;,&quot;Value 2&quot;,&quot;Value 3&quot;]" value="<?php echo $servicio['catHospitalName'] ?>" placeholder="" aria-describedby="basic-addon1"></td>
                                </tr>
                                <!--<tr>
            ...
            <div class="modal-footer">
                <div class="footer_form_appointment">
                    ...
                    <button type="button" class="btn btn-primary enviarSolicitudCita"  data-url="/citas/agendarCita" data-selector-form="#createAppointmentForm_<?php echo $servicio['idcatservicio']  ?>" id="submitButton">Save</button>
                </div>
            </div>
        </div>
    </div>
